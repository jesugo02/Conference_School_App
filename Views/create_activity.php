        ...
        <div id="create-activity">
            ...
            <form method="post" action="index.php?action=create_activity" class="create-activity-form">
                ...
                <div class="create-activity-groupefield">
                    ...
                    <span class="error"> <?php echo  $error_name_act ;?></span>
                </div>
                ...
                <div class="create-activity-groupefield">
                    ...
                    <span class="error"> <?php echo $error_type_act;?></span>
                </div>
                ...
                <div class="create-activity-groupefield">
                    ...
                    <span class="error"> <?php echo $error_date_act;?></span>
                </div>
                ...
                <div class="create-activity-groupefield">
                    ...
                    <span class="error"> <?php echo $error_desc_act;?></span>
                </div>
                <div class="create-activity-groupefield">
